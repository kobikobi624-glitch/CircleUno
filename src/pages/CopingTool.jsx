...
// Structured coping exercise steps
  ...
  const finishExercise = async (finalAnswers) => {
    ...
    try {
      await addDoc(collection(db, "copingSessions"), {
        ...
        anxietyAfter: finalAnswers.after,
              ...
              <>
                {!timer && (
                  <button
                    ...
                    style={{ width: "100%", padding: 12, borderRadius: 12, border: "none", background: "#eef2ff", color: "#6366f1", fontWeight: 700, fontSize: 15, cursor: "pointer", marginBottom: 10 }}
                  >
